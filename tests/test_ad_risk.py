...
ARTIFACTS_DIR = Path(__file__).parent.parent / "_artifacts"
...
class TestADrisk(unittest.TestCase):
    ...
    def test_1(self) -> None:
        ...
        print(f"TestADrisk_pred={preds[0]:.8f}")
...
class TestADriskFromVCF(unittest.TestCase):
    ...
    def test_1(self) -> None:
        ...
        print(f"TestADriskFromVCF_pred0={preds.iloc[0].ad_risk.item():.8f}")
        print(f"TestADriskFromVCF_pred1={preds.iloc[1].ad_risk.item():.8f}")
